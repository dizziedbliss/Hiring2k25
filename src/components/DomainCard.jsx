        ...
        >
            ...
            `}>
                ...
                <div className="p-4 relative z-10">
                    {/* Title container with fixed height to stabilize layout */}
                    <div className="h-12">
                    ...
                    `}>
                        <div className="overflow-hidden">
                            <div className="w-1/2">
                                <p className="text-sm text-gray-700 leading-tight pt-2">
                                    {description}
                                </p>
                                <button 
                                    onClick={(e) => {
                                    ...
                                    className={`
                                        mt-4 px-6 py-1.5 rounded-lg text-lg font-bold
                                        text-gray-800 bg-yellow-400 border-2 border-black
            ...
            <img 
                ...
                className={`
                    ...
                    transition-all duration-500 ease-in-out
                    ${isExpanded ? 
                        'w-40 h-40 top-1/2 right-4 -translate-y-1/2' : 
                        'w-32 h-32 top-0 right-4'}
                `}
            />
        </div>
    );
